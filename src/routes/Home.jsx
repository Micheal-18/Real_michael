          ...
          <div className='flex gap-6 items-center px-8'>
            ...
            <div className='mt-10 text-center md:text-center ' >
              ...
              <div className='flex justify-center gap-4'>
                <button className='text-white text-center px-4 py-2 mt-3 rounded-md border-1 border-white border-solid  bg-gradient-to-r from-yellow-500 via-yellow to-black transition  duration-200 ease-in-out hover:-translate-y-1 hover:scale-110  text-lg'>Project</button>
                <button className='text-white text-center px-4 mr-5 py-2 mt-3 rounded-md border-1 border-white border-solid bg-gradient-to-r from-black via-yellow to-yellow-500 transition  duration-200 ease-in-out hover:-translate-y-1 hover:scale-110  text-lg'>Resume</button>
              </div>
            </div>
          </div>
        </div>
