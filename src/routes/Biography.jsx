      ...
      <div className='max-w-6xl text-center mx-auto px-4 '>
        ...
        <RevealOnScroll>
          ...
          <div className='text-white md:text-left text-left'>
            ...
            <div data-aos="fade-out"  className='rounded-xl p-6  hover:translate-y-1  transition-all'>
        ...
        <div className='grid grid-cols-1 text-left md:grid-cols-2 gap-6 mt-8'>
          <div data-aos="slide-left" className='p-6 rounded-xl border-yellow-500/10   border hover:-translate-y-1 transition-all '>
          ...
          <div data-aos="slide-right" className='p-6 rounded-xl border-yellow-500/10   border hover:-translate-y-1 transition-all'>
