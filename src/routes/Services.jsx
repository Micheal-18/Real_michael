      ...
      <div className='max-w-5xl mx-auto px-4 '>
        ...
        <RevealOnScroll>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div ref={Ref} className={`p-6 rounded-xl border border-white/10 hover:-translate-y-1 ${InView ? 'animation-left' : ''} hover:border-yellow-500/30 rgba(255, 255, 59, 0.1)] transition`}>
            ...
            <div ref={Ref} className={`p-6 rounded-xl border border-white/10 hover:-translate-y-1 ${InView ? 'animation-right' : ''} hover:border-yellow-500/30 rgba(255, 255, 59, 0.1)] transition`}>
              <h3 className='text-xl font-bold mb-2'>
                Resturant Site
              </h3>
